...
process diff_gene_expr_edger_bowtie2 {
    ...
    output:
    path "EdgeR_control_condition1.csv", emit: control_vs_condition1
    path "EdgeR_control_condition2.csv", emit: control_vs_condition2
